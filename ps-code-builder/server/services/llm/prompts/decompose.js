...
- **COMPONENT INTERFACE RULE**: If the requirement mentions "Component Interface", "CI", "batch", "Integration Broker", "Excel to CI", or "must run online and batch", add "Component Interface CI mode events do not fire %CompIntfcName interactive functions PeopleCode" to additionalRagQueries. Prefer CI-firing events (SaveEdit, FieldEdit, RowInit, SavePreChange) for must-run logic over SearchInit/RowSelect/FieldFormula/Activate which are skipped under CI.
